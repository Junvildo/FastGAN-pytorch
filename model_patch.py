...
class NLayerDiscriminator(nn.Module):
    ...
    def __init__(self, input_nc, ndf=64, n_layers=3, norm_layer=nn.BatchNorm2d, im_size=512):
    ...
    def forward(self, input):
        ...
        if type(input) is not list:
            input = [F.interpolate(input, size=self.im_size), F.interpolate(input, size=128)]
...
class PixelDiscriminator(nn.Module):
    ...
    def __init__(self, input_nc, ndf=64, norm_layer=nn.BatchNorm2d, im_size=512):
